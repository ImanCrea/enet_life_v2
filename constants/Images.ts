export default {
    onBoardingLogo: require('../assets/onboard-logo.png'),
    eyeOffIcon: require('../assets/eye-hide.png'),
    eyeIcon: require('../assets/eye-open.png'),
    ...
    onBoardingTwo: require('../assets/second.png'),
    onBoardingThree: require('../assets/third.png'),

    connectImage: require('../assets/connect.png'),
    forgotPassword: require('../assets/forgot-password2.png'),
    avatar: require('../assets/avatar.png'),
